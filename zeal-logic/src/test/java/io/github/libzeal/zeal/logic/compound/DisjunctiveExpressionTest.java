...
class DisjunctiveExpressionTest {
    ...
    void givenNullChildEntry_whenConstruct_thenExceptionThrown() {
        ...
        assertThrows(
            NullPointerException.class,
            () -> new DisjunctiveExpression("foo", children)
        );
    }
    ...
    void givenNullChildEntry_whenWithDefaultName_thenExceptionThrown() {
        ...
        assertThrows(
            NullPointerException.class,
            () -> DisjunctiveExpression.withDefaultName(children)
        );
    }
    ...
    void whenWithDefaultName_thenCorrectNameThrown() {
        ...
        final Expression defaultNameExpression = DisjunctiveExpression.withDefaultName(children);

        assertEquals(DisjunctiveExpression.DEFAULT_NAME, defaultNameExpression.name());
    }
