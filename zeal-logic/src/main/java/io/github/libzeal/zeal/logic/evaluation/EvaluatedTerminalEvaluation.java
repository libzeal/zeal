 ...
 * @since 0.2.1
 */
public class EvaluatedTerminalEvaluation implements TerminalEvaluation {
    ...
    EvaluatedTerminalEvaluation(final Result result, final String name, final Rationale rationale,
     ...
     */
    public static EvaluatedTerminalEvaluation ofTrue(final String name, final Rationale rationale, final Duration elapsedTime) {
        return new EvaluatedTerminalEvaluation(Result.TRUE, name, rationale, elapsedTime, CauseGenerator.self());
    }
     ...
     */
    public static EvaluatedTerminalEvaluation ofFalse(final String name, final Rationale rationale, final Duration elapsedTime) {
        return new EvaluatedTerminalEvaluation(Result.FALSE, name, rationale, elapsedTime, CauseGenerator.self());
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof EvaluatedTerminalEvaluation)) return false;

        final EvaluatedTerminalEvaluation that = (EvaluatedTerminalEvaluation) o;
