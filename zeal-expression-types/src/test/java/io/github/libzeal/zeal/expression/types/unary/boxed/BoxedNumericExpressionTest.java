...
import io.github.libzeal.zeal.expression.types.unary.ObjectUnaryExpressionTest;
import io.github.libzeal.zeal.expression.types.unary.test.ExpressionTestCaseBuilder;
import io.github.libzeal.zeal.expression.types.unary.ObjectUnaryExpression;
...
public abstract class BoxedNumericExpressionTest<T extends Number, E extends BoxedNumericUnaryExpression<T, E>>
    ...
    private void isEqualToTestCases(final ExpressionTestCaseBuilder<T, E> builder) {
        ...
        builder.newTest((expression, value) -> expression.isEqualTo(value1))
                ...
                .expectedExpectedValue(ObjectUnaryExpression.stringify(value1))
                .expectedActualValue(ObjectUnaryExpression.stringify(value1))
                .addTest()
            .newTest((expression, value) -> expression.isEqualTo(value1))
                ...
                .expectedName("isEqualTo[" + ObjectUnaryExpression.stringify(value1) + "]")
                .expectedExpectedValue(ObjectUnaryExpression.stringify(value1))
                .expectedActualValue(ObjectUnaryExpression.stringify(value2))
                .addTest();
    }
    ...
    private void isNotEqualToTestCases(final ExpressionTestCaseBuilder<T, E> builder) {
        ...
        builder.newTest((expression, value) -> expression.isNotEqualTo(value1))
                ...
                .expectedExpectedValue("not[" + ObjectUnaryExpression.stringify(value1) + "]")
                .expectedActualValue(ObjectUnaryExpression.stringify(value1))
                .addTest()
    ...
    private void isLessThanTestCases(final ExpressionTestCaseBuilder<T, E> builder) {
        ...
        builder.newTest((expression, value) -> expression.isLessThan(zero))
                ...
                .expectedExpectedValue("< " + ObjectUnaryExpression.stringify(zero))
                .expectedActualValue(ObjectUnaryExpression.stringify(positive))
                .addTest()
            .newTest((expression, value) -> expression.isLessThan(zero))
                ...
                .expectedName("isLessThan[" + ObjectUnaryExpression.stringify(zero) + "]")
                .expectedExpectedValue("< " + ObjectUnaryExpression.stringify(zero))
                .expectedActualValue(ObjectUnaryExpression.stringify(zero))
                .addTest()
            .newTest((expression, value) -> expression.isLessThan(zero))
                .value(negative)
                .expectedState(PASSED)
                .expectedName("isLessThan[" + ObjectUnaryExpression.stringify(zero) + "]")
                .expectedExpectedValue("< " + ObjectUnaryExpression.stringify(zero))
                .expectedActualValue(ObjectUnaryExpression.stringify(negative))
                .addTest();
    }
    ...
    private void isNotZeroTestCases(final ExpressionTestCaseBuilder<T, E> builder) {
        ...
        builder.newTest((expression, value) -> expression.isNotZero())
                ...
                .expectedExpectedValue("not[" + ObjectUnaryExpression.stringify(zero) + "]")
                .expectedActualValue(ObjectUnaryExpression.stringify(positive))
                .addTest()
