...
abstract class EnumExpressionTest<T extends Enum<T>> extends ObjectExpressionTest<T, GeneralEnumExpression<T>> {
    
    @Override
    protected void extendTestCases(ExpressionTestCaseBuilder<T, GeneralEnumExpression<T>> builder) {
    ...
    private void ordinalIsTestCases(ExpressionTestCaseBuilder<T, GeneralEnumExpression<T>> builder) {
    ...
    private void ordinalIsNotTestCases(ExpressionTestCaseBuilder<T, GeneralEnumExpression<T>> builder) {
    ...
    private void nameIsTestCases(ExpressionTestCaseBuilder<T, GeneralEnumExpression<T>> builder) {
    ...
    private void nameIsNotTestCases(ExpressionTestCaseBuilder<T, GeneralEnumExpression<T>> builder) {
    ...
    private void caseInsensitiveNameIsTestCases(ExpressionTestCaseBuilder<T, GeneralEnumExpression<T>> builder) {
    ...
    private void caseInsensitiveNameIsNotTestCases(ExpressionTestCaseBuilder<T,
        GeneralEnumExpression<T>> builder) {
