...
class DisjunctiveCriteriaTest {

    private String name;
    private DisjunctiveCriteria<Object> criteria;
    ...
    void setUp() {
        ...
        criteria = new DisjunctiveCriteria<>(name, new ArrayList<>());
    }
    ...
    void givenNullName_whenConstruct_thenExceptionThrown() {
        ...
        assertThrows(
            ...
            () -> new DisjunctiveCriteria<>(null, list)
        );
    }
    ...
    void givenNullCriteriaList_whenConstruct_thenExceptionThrown() {
        assertThrows(
            NullPointerException.class,
            () -> new DisjunctiveCriteria<>(name, null)
        );
    }
    ...
    void givenNoSubCriteria_whenEvaluate_thenEvaluationIsCorrect() {
        ...
        assertInstanceOf(DisjunctiveEvaluation.class, evaluation);
    }
    ...
    void givenOnePassingCriteriaPrependedBeforeFailingCriteria_whenEvaluate_thenEvaluationIsCorrect() {
        ...
        assertEquals(Result.PASSED, evaluation.result());
        assertInstanceOf(DisjunctiveEvaluation.class, evaluation);
        assertIsSkipped(failingSubCriteria, subject);
    }
}
