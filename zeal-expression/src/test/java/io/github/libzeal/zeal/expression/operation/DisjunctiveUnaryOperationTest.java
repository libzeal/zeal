...
import io.github.libzeal.zeal.expression.operation.unary.DisjunctiveUnaryOperation;
...
class DisjunctiveUnaryOperationTest {

    private String name;
    private DisjunctiveUnaryOperation<Object> operation;
    ...
    void setUp() {
        ...
        operation = new DisjunctiveUnaryOperation<>(name, new ArrayList<>());
    }
    ...
    void givenNullName_whenConstruct_thenExceptionThrown() {
        ...
        assertThrows(
            ...
            () -> new DisjunctiveUnaryOperation<>(null, list)
        );
    }
    ...
    void givenNullOperationList_whenConstruct_thenExceptionThrown() {
        assertThrows(
            NullPointerException.class,
            () -> new DisjunctiveUnaryOperation<>(name, null)
        );
    }
    ...
    void givenNullName_whenConstructWithNameOnly_thenExceptionThrown() {
        assertThrows(
            NullPointerException.class,
            () -> new DisjunctiveUnaryOperation<>(null)
        );
    }
    ...
    void givenOnePassingOperationPrependedBeforeFailingOperation_whenEvaluate_thenEvaluationIsCorrect() {
        ...
        assertNotNull(evaluation.rationale());
        assertEquals(2, evaluation.children().size());
        assertIsSkipped(failingSubOperation, subject);
    }
}
