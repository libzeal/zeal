...
class DisjunctiveUnaryPredicateTest {
    ...
    void givenTwoChildren_whenSkip_thenEvaluationIsCorrect() {
        ...
        UnaryPredicate<Object> subPredicate1 = unaryPredicate(subPredicateName1, Result.FAILED);
        UnaryPredicate<Object> subPredicate2 = unaryPredicate(subPredicateName2, Result.FAILED);
