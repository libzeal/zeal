 ...
 *     {@link ObjectUnaryExpression}. If {@link ObjectUnaryExpression} were returned from the fluent interface methods, then the
 *     subclass type would be lost, resulting in the methods available on the subtype to no longer be available as
 *     methods from {@link ObjectUnaryExpression} are called. For example, if a {@code StringExpression} (extending this
